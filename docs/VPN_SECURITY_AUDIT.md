...
| Product lifecycle | Explicit state machine, crash-preserved guard, rotating logs, authenticated TLS/WebSocket startup/periodic probes, jittered bounded reconnect | Egress-based health and physical Windows E2E |
